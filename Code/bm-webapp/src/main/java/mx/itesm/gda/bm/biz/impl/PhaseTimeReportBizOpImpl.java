    ...
    public String getPhaseTimeReport(int project_id){
        ...
        for(int i = 0; i < phaseTimes.size(); i++){
            if (totalEstimatedHours != 0){
                phasePercents.add(roundNumber(100*((double)phaseTimes.get(i)/(double)totalEstimatedHours)));
            }
            else {
        ...
        xmlData += "<chart caption='Tiempo de fase' xAxisName='Fase' yAxisName='Porcentaje'>";
