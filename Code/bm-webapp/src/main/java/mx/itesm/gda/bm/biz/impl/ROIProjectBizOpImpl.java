...
public class ROIProjectBizOpImpl extends AbstractBizOp implements ROIProjectBizOp{
    ...
    public String getROIProjectReport(int project_id){
        String xmlData = null;
        long requirementsEffort = 0, designEffort = 0, codingEffort = 0, totalEffort = 0;
        long taskReqEffort = 0, taskDesignEffort = 0, taskCodingEffort = 0, taskTotalEffort = 0;
        List<Defect> requirementsDefects, designDefects, codingDefects;
        List<Task> reqTasks, designTasks, codingTasks;
        ...
        totalEffort = requirementsEffort + designEffort + codingEffort;

        taskTotalEffort = taskReqEffort + taskDesignEffort + taskCodingEffort;
